...
| [`Implementation/docs/`](Implementation/docs) | The plan for a verifiable translator: what may be proved, the input format, the mCRL2 target, and which languages to build it in |
| [`Implementation/Lean/`](Implementation/Lean) | The translator itself, in Lean 4 — CPN file in, mCRL2 text out, with the emitted specification proved bisimilar to the CPN’s reachability graph |
