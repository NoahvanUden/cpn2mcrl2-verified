...
| [`Implementation/Lean/`](Implementation/Lean) | The translator itself, in Lean 4 — CPN file in, mCRL2 text out, with the emitted term proved to denote Definition 14 |
